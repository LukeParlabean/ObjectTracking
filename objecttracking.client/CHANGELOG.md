...
- Create Angular project with ng: `ng new objecttracking.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`objecttracking.client.esproj`).
